...
import id.ac.umn.dimas.week13_41281.databinding.ActivityTambahObjectBinding;

public class TambahObject extends FragmentActivity implements OnMapReadyCallback {

    private GoogleMap mMap;
    private ActivityTambahObjectBinding binding;
    private int pilihan = 0; // 0 = Marker; 1 = Circle; 2 = Polyline; 3 = Polygon
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityTambahObjectBinding.inflate(getLayoutInflater());
                ...
                switch (pilihan) {
                    case 0:
                        ...
                        if (mMap != null) {
                            ...
                            objMS = new MarkerAndShape("Marker", etKeterangan.getText().toString(), 0.0, titiks);
                    ...
                    case 1:
                        ...
                        if (mMap != null) {
                            ...
                            if (rad.length() > 0 && Double.parseDouble(rad) > 0.0) {
                                ...
                                objMS = new MarkerAndShape("Circle", etKeterangan.getText().toString(), radius, titiks);
                                btnSimpan.setEnabled(true);
                            }
                        }
                        break;
                    case 2:
                        ...
                        if (titiks.size() == 1) {
                            ...
                            mMap.addPolyline(pl);
                            objMS = new MarkerAndShape("PolyLine", etKeterangan.getText().toString(), 0, titiks);
                            btnSimpan.setEnabled(true);
                        }
                        break;
                    case 3:
                        ...
                        if (titiks.size() == 1) {
                            ...
                            objMS = new MarkerAndShape("Polygon", etKeterangan.getText().toString(), 0, titiks);
                            btnSimpan.setEnabled(true);
                        }
                        break;
                }
