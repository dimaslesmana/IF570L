package id.ac.umn.dimas.week07a_41281;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        foto = findViewById(R.id.button1);
        ...
        videoController.setMediaPlayer(kotakVideo);
        kotakVideo.setMediaController(videoController);
