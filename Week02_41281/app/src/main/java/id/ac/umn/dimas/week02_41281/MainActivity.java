package id.ac.umn.dimas.week02_41281;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void hitung(char operator) {
        if (isEmptyString(angka1.getText().toString()) || isEmptyString(angka2.getText().toString())) {
            hasil.setText("Please fill in all the input!");
            return;
        }
    ...
    private boolean isEmptyString(String strNumber) {
        return strNumber.trim().length() == 0;
    }
}